...
var HomeComponent = /** @class */ (function () {
    ...
    function HomeComponent(moviesService, router) {
    ...
    HomeComponent.prototype.goToDetails = function (id) {
...
var MovieComponent = /** @class */ (function () {
    function MovieComponent(moviesService, route, router) {
        this.moviesService = moviesService;
        this.route = route;
        this.router = router;
    }
    MovieComponent.prototype.ngOnInit = function () {
        ...
        this.moviesService.getMovie(this.movieId).subscribe(function (movie) {
            _this.movie = movie;
        });
        // assign appropriate values
        this.imgBaseUrl = this.moviesService.getImgBaseUrl();
    ...
    MovieComponent.prototype.goHome = function (id) {
...
var MoviesService = /** @class */ (function () {
    ...
    MoviesService.prototype.getApiKey = function () {
        return this.apiKey;
    };
    MoviesService.prototype.getImgBaseUrl = function () {
